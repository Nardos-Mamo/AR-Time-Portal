            ...
            NavigationView {
                ScrollView{
                    ...
                    VStack{
                        ...
                        HStack(spacing: 15) {
                            NavigationLink(destination: SongListView(songs: ["Song 21", "Song 22", "Song 23", "Song 24", "Song 25"], images: ["Collossium", "Ice Age", "Pyramid", "Taj Maha", "Paris"], titles: ["Goddess of Music", "Roman Battle", "Medusa", "Anubis","Kings of God"])) {
                                MIcon(title: "Collossium", lineArt: "colArt")
                            }
                            
                            NavigationLink(destination: SongListView(songs: ["Song 26", "Song 27", "Song 28", "Song 29", "Song 30"], images: ["Ice Age", "Pyramid", "Taj Maha", "Paris", "Jurrasic"], titles: ["Freeze", "Sound of Ice", "SnowFall", "Frozen Call", "Wolf Song"])) {
...
//                    .background(backgroundColors[index % backgroundColors.count])
        ...
        .onDisappear {
                        // Stop playing when the view disappears
                        player?.stop()
                        isPlaying = false
    ...
    private func playSong(_ fileName: String) {
        guard let url = Bundle.main.url(forResource: fileName, withExtension: "mp3", subdirectory: "Sounds all") else {
